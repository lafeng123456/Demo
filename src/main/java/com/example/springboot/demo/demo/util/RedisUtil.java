...
import com.example.springboot.demo.demo.domain.bean.RedisDto;
...
//    }
    ...
    public long getAndSetNumber(String key , long value){
        long result = 0;
        Object o = redisTemplate.opsForValue().getAndSet(key, String.valueOf(value));
        if(null != o){
            result = Long.parseLong(String.valueOf(o));
        }
        return result;
    }
